'''
python svg_to_world.py 2deaa98e9acd1293d5224e25715c1393_out.svg 0.02
python svg_to_world.py 2deaa98e9acd1293d5224e25715c1393_out.svg 0.012
...
from tensorflow.keras.layers import Dense, Flatten, Dropout, PReLU, TimeDistributed
...
env = Environment("Simulation2d/svg/2deaa98e9acd1293d5224e25715c1393_out", 2)
...
def build_model(states, actions):
	model = Sequential()
	model.add(Dense(9672, input_dim=states, activation='relu'))
	model.add(Dense(4836, activation='relu'))
	model.add(Dense(2418, activation='relu'))
...
def build_model(states, actions):
	model = Sequential()
	model.add(Dense(4836, input_dim=states, activation='relu'))
	model.add(Dense(2418, activation='relu'))
	model.add(Dense(512, activation='relu'))
	model.add(Dropout(0.25))
	model.add(Dense(256, activation='relu'))
...
callbacks = build_callbacks('2deaa98e9acd1293d5224e25715c1393_out')
