...
env = Environment("Simulation2d/svg/ac5ac75376e2e43d9bb14460e41271d0_out", 9)
...
def build_agent(model, actions):
	...
	dqn = DQNAgent(model=model, memory=memory, policy=policy, processor=processor,
		...
		batch_size=8, gamma=.99)
	return dqn

model = build_model(states, actions)
dqn = build_agent(model, actions)
callbacks = build_callbacks('ac5ac75376e2e43d9bb14460e41271d0_out_9')
