...
env = Environment("Simulation2d/svg/ac5ac75376e2e43d9bb14460e41271d0_out", 10)
...
def build_callbacks(env_name):
    ...
    callbacks = [ModelIntervalCheckpoint(weights_filename, interval=100_000, verbose=1)]
...
callbacks = build_callbacks('ac5ac75376e2e43d9bb14460e41271d0_out_10')
...
dqn.fit(env, nb_steps=N_STEPS, visualize=True, verbose=1, log_interval=1_000, callbacks=callbacks)
